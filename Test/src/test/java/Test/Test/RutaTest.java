...
import Test.Test.TestMain.RutaMention;
...
public class RutaTest {
	...
	public void test() throws IOException, UIMAException {
		...
		AnalysisEngineDescription aed = AnalysisEngineFactory.createEngineDescriptionFromPath("target/generated-sources/ruta/descriptor/${myPackage.replaceAll("[.]", "/")}/TestMainRutaAnnotator.xml");
